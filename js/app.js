...
var storeApp = angular.module('retroTeeCoApp', ['ngRoute', 'ngAnimate', 'angulartics', 'angulartics.google.analytics']).
...
//    myCart.addCheckoutParameters("PayPal", "corsaro22@tiscali.it");
    myCart.addCheckoutParameters("PayPal", "ernesto@retroteeco.com");
...
storeApp.animation('.faq-answer', function() {
  return {
